...
#import <BambuserBroadcaster/BambuserConstants.h>
 ...
 * The supplied speed is bytes per second, -1 if test fails or can't be done. shouldBroadcast is YES if attempting
